  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "http://localhost:3003/api/addProduct",
        formData,
      ...
      <form onSubmit={handleSubmit} className="add-product-form">
        ...
        <div className="form-field">
          ...
          >
            ...
            <option value="eye">Eye Cosmetics</option>
            <option value="lip">Lip Cosmetics</option>
            <option value="nail">Nail Cosmetics</option>
            <option value="skincare">Skincare-Cosmetics</option>
            <option value="occasion">Occasion Cosmetics</option>
            <option value="accessories">Tools and Accessories</option>
            <option value="fashFion">Fashion Categories</option>
          </select>
        </div>
